...
/****** Object:  View [dbo].[vwCarrierConfirmationReportFinalDestination]    Script Date: 12-08-2022 11:05:40 ******/
SET ANSI_NULLS ON
GO
...
SELECT     dbo.LoadStops.Address, dbo.LoadStops.City, dbo.LoadStops.StateCode, dbo.LoadStops.PostalCode, dbo.LoadStops.ContactPerson, dbo.LoadStops.Phone, 
                      ...
                      dbo.LoadStops.StopTime AS FinalDelivTime, dbo.LoadStops.EmailID, dbo.LoadStops.ReleaseNo
...
/****** Object:  View [dbo].[ExportSalesSummary]    Script Date: 12-08-2022 11:02:31 ******/
SET ANSI_NULLS ON
GO
...
SELECT        TOP (100) PERCENT dbo.Offices.Location, dbo.Offices.OfficeCode, dbo.Employees.Name AS Dispatcher, ISNULL(NULLIF (Employees_1.Name, N''), N'(BLANK)') AS SalesAgent1, dbo.Loads.LoadNumber, dbo.Loads.orderDate, 
                         ...
                         * (dbo.Employees.SalesCommission * .01), 0) AS DispatchCommissionAmt, dbo.Carriers.CarrierName AS [Carrier/Driver], Employees_1.Name AS SalesAgent, 
                         ...
                         dbo.vwCarrierConfirmationReportFinalDestination.PostalCode AS [Last Stop Zip],  dbo.vwCarrierConfirmationReportFinalDestination.ReleaseNo AS [Last Pickup #], dbo.vwCarrierConfirmationReportFinalDestination.FinalDelivDate AS [Delivery Date], dbo.LoadStops.LoadStopID, 
