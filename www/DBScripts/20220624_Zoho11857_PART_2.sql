IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'BillFromCompanies' and column_name = 'RemitInfo1')
BEGIN
	ALTER TABLE BillFromCompanies ADD RemitInfo1 varchar(50);
END
IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'BillFromCompanies' and column_name = 'RemitInfo2')
BEGIN
	ALTER TABLE BillFromCompanies ADD RemitInfo2 varchar(50);
END
IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'BillFromCompanies' and column_name = 'RemitInfo3')
BEGIN
	ALTER TABLE BillFromCompanies ADD RemitInfo3 varchar(50);
END
IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'BillFromCompanies' and column_name = 'RemitInfo4')
BEGIN
	ALTER TABLE BillFromCompanies ADD RemitInfo4 varchar(50);
END
IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'BillFromCompanies' and column_name = 'RemitInfo5')
BEGIN
	ALTER TABLE BillFromCompanies ADD RemitInfo5 varchar(50);
END
IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'BillFromCompanies' and column_name = 'RemitInfo6')
BEGIN
	ALTER TABLE BillFromCompanies ADD RemitInfo6 varchar(50);
END

GO

/****** Object:  View [dbo].[vwCustomerInvoiceReportSub]    Script Date: 24-06-2022 14:57:39 ******/
SET ANSI_NULLS ON
GO
