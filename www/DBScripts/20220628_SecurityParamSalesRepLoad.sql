IF(SELECT COUNT(ID) FROM SecurityParameter WHERE parameter = 'SalesRepLoad') = 0
BEGIN
INSERT INTO [SecurityParameter] 
([Category],[Parameter],[Description],[CreatedBy],[ModifiedBy],[Type]) 
VALUES ('Edit','SalesRepLoad','Allow the user to view only the Loads with their user information preset as the Sales Rep.','Scott','Scott','Load')
END

GO

/****** Object:  StoredProcedure [dbo].[USP_GetLoadListBETA]    Script Date: 28-06-2022 09:27:02 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[USP_GetLoadList]    Script Date: 28-06-2022 09:50:49 ******/
SET ANSI_NULLS ON
GO
