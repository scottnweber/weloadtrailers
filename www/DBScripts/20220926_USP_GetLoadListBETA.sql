...
/****** Object:  StoredProcedure [dbo].[USP_GetLoadListBETA]    Script Date: 26-09-2022 11:31:32 ******/
SET ANSI_NULLS ON
GO
	...
	ELSE
		BEGIN
			...
			SET @sql=@sql+'SELECT 
					...
					LEFT JOIN LoadStatusTypes FLST ON FLST.StatusOrder <= LST.StatusOrder AND ISNULL(FLST.ForceNextStatus,0) = 1 AND FLST.CompanyID = LST.CompanyID
			...
			SET @sql=@sql+' WHERE O.CompanyID = '''+@CompanyID+''''
