UPDATE SystemConfig SET LoadsColumns = LoadsColumns  + ',Invoice Date' WHERE CompanyID ='56BFEDEC-E133-4C0B-9353-07B4BAD63C65' AND LoadsColumns   NOT LIKE '%Invoice Date%'
UPDATE SystemConfig SET LoadsColumnsStatus = LoadsColumnsStatus  + ',1' WHERE CompanyID ='56BFEDEC-E133-4C0B-9353-07B4BAD63C65'


/****** Object:  StoredProcedure [dbo].[USP_GetLoadList]    Script Date: 19/05/2022 11:59:28 ******/
SET ANSI_NULLS ON
GO
