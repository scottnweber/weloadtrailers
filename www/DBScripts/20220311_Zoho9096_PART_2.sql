IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Loads' and column_name = 'HasLateStop')
BEGIN
	ALTER TABLE Loads ADD HasLateStop bit not null default 0;
END

GO

/****** Object:  View [dbo].[vwSalesRepCommission]    Script Date: 3/11/2022 10:45:06 AM ******/
SET ANSI_NULLS ON
GO
