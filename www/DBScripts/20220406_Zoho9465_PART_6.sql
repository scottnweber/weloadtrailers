IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'SystemConfig' and column_name = 'ApplyBillFromCompanyToCarrierReport')
BEGIN
	ALTER TABLE SystemConfig ADD ApplyBillFromCompanyToCarrierReport bit not null default 0;
END

GO

/****** Object:  View [dbo].[vwCustomerInvoiceReportSub]    Script Date: 06-04-2022 13:15:53 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[USP_GetCarrierReport]    Script Date: 06-04-2022 14:56:14 ******/
SET ANSI_NULLS ON
GO
