IF EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Loads' and column_name = 'CustRep')
BEGIN
	EXEC sp_RENAME 'Loads.CustRep', 'SalesRep1', 'COLUMN'
END
IF EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Loads' and column_name = 'CustRepPercentage')
BEGIN
	EXEC sp_RENAME 'Loads.CustRepPercentage', 'SalesRep1Percentage', 'COLUMN'
END
IF EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Loads' and column_name = 'ShipperRep')
BEGIN
	EXEC sp_RENAME 'Loads.ShipperRep', 'SalesRep2', 'COLUMN'
END
IF EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Loads' and column_name = 'ShipperRepPercentage')
BEGIN
	EXEC sp_RENAME 'Loads.ShipperRepPercentage', 'SalesRep2Percentage', 'COLUMN'
END
IF EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Loads' and column_name = 'CarrierRep')
BEGIN
	EXEC sp_RENAME 'Loads.CarrierRep', 'SalesRep3', 'COLUMN'
END
IF EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Loads' and column_name = 'CarrierRepPercentage')
BEGIN
	EXEC sp_RENAME 'Loads.CarrierRepPercentage', 'SalesRep3Percentage', 'COLUMN'
END

GO
UPDATE Loads SET SalesRep1 = NULL WHERE SalesRep1 = ''
UPDATE Loads SET SalesRep2 = NULL WHERE SalesRep2 = ''
UPDATE Loads SET SalesRep3 = NULL WHERE SalesRep3 = ''
UPDATE Loads SET Dispatcher1 = NULL WHERE Dispatcher1 = ''
UPDATE Loads SET Dispatcher2 = NULL WHERE Dispatcher2 = ''
UPDATE Loads SET Dispatcher3 = NULL WHERE Dispatcher3 = ''

ALTER TABLE Loads ALTER COLUMN SalesRep1 UniqueIdentifier;
ALTER TABLE Loads ALTER COLUMN SalesRep2 UniqueIdentifier;
ALTER TABLE Loads ALTER COLUMN SalesRep3 UniqueIdentifier;
ALTER TABLE Loads ALTER COLUMN Dispatcher1 UniqueIdentifier;
ALTER TABLE Loads ALTER COLUMN Dispatcher2 UniqueIdentifier;
ALTER TABLE Loads ALTER COLUMN Dispatcher3 UniqueIdentifier;
GO
/****** Object:  StoredProcedure [dbo].[USP_GetLoadDetails]    Script Date: 11/03/2022 11:07:25 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[USP_InsertLoad]    Script Date: 11/03/2022 11:45:42 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
