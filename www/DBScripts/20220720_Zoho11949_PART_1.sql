IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Customers' and column_name = 'LockDispatcher2OnLoad')
BEGIN
	ALTER TABLE Customers ADD LockDispatcher2OnLoad bit not null default 0;
END
...
GO
/****** Object:  StoredProcedure [dbo].[USP_GetCustomerDetails]    Script Date: 7/20/2022 10:40:49 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[USP_UpdateCustomer]    Script Date: 7/20/2022 10:50:23 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(	
	...
	@salesperson2 as varchar(36)= null,
	@Dispatcher2 as  varchar(36)= null,
	@LockDispatcher2OnLoad as bit
)
AS
BEGIN
	UPDATE Customers SET
		...
		SalesRepID2=@salesperson2,
		AcctMGRID2=@Dispatcher2,
		LockDispatcher2OnLoad=@LockDispatcher2OnLoad
...
GO
/****** Object:  StoredProcedure [dbo].[USP_InsertCustomer]    Script Date: 7/20/2022 10:42:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
