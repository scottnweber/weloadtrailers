...
IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'FileAttachments' and column_name = 'InsExpDate')
BEGIN
	ALTER TABLE FileAttachments ADD InsExpDate date default null;
END