...
/****** Object:  View [dbo].[ExportSalesSummary]    Script Date: 03-10-2022 18:48:25 ******/
SET ANSI_NULLS ON
GO
...
SELECT        TOP (100) PERCENT dbo.Offices.Location, dbo.Offices.OfficeCode, dbo.Employees.Name AS Dispatcher, ISNULL(NULLIF (Employees_1.Name, N''), N'(BLANK)') AS SalesAgent1, dbo.Loads.LoadNumber, dbo.Loads.orderDate, 
						 ...
						 dbo.Loads.TotalCarrierCharges, dbo.Loads.BillDate AS InvoiceDate, dbo.Loads.InternalRef,
                         ...
                         * (dbo.Employees.SalesCommission * .01), 0) AS DispatchCommissionAmt, dbo.Carriers.CarrierName AS [Carrier/Driver], Employees_1.Name AS SalesAgent, 
                         ...
                         dbo.LoadStops.Address AS [First Stop Address], dbo.LoadStops.City AS [First Stop City], dbo.LoadStops.StateCode AS [First Stop State], dbo.LoadStops.PostalCode AS [First Stop Zip],  dbo.LoadStops.ReleaseNo AS [First Pickup #], 
                         ...
                         dbo.vwCarrierConfirmationReportFinalDestination.PostalCode AS [Last Stop Zip],  dbo.vwCarrierConfirmationReportFinalDestination.ReleaseNo AS [Last Delivery #], dbo.vwCarrierConfirmationReportFinalDestination.FinalDelivDate AS [Delivery Date], dbo.LoadStops.LoadStopID, 
						...
						,CASE WHEN dbo.SystemConfig.BillFromCompanies = 1 AND dbo.Loads.BillFromCompany IS NOT NULL AND dbo.Loads.BillFromCompany <> dbo.SystemConfig.CompanyID THEN dbo.BillFromCompanies.CompanyName ELSE dbo.Companies.CompanyName END AS [Bill From]
						 ,dbo.LoadStops.NewDriverName AS [Driver 1], dbo.LoadStops.NewDriverName2 AS [Driver 2]
...
/****** Object:  View [dbo].[ExportSalesDetail]    Script Date: 03-10-2022 18:56:07 ******/
SET ANSI_NULLS ON
GO
...
SELECT  TOP 100 PERCENT dbo.ExportSalesSummary.Dispatcher, dbo.ExportSalesSummary.SalesAgent1, dbo.ExportSalesSummary.LoadNumber, dbo.ExportSalesSummary.orderDate, dbo.ExportSalesSummary.CustName, 
                         ...
                         dbo.ExportSalesSummary.EquiptName, dbo.ExportSalesSummary.DispatchCommissionPercent, dbo.ExportSalesSummary.DispatchCommissionAmt, dbo.ExportSalesSummary.[Carrier/Driver],  dbo.ExportSalesSummary.[Driver 1],  dbo.ExportSalesSummary.[Driver 2], 
                         ...
                         dbo.LoadStopCommodities.CarrRateOfCustTotal,dbo.ExportSalesSummary.[Delivery Date],dbo.ExportSalesSummary.CompanyID,dbo.ExportSalesSummary.OfficeCode,dbo.ExportSalesSummary.InternalRef
