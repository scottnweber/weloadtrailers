...
/****** Object:  StoredProcedure [dbo].[USP_GetLoadList]    Script Date: 14-06-2022 10:34:09 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	ELSE
		BEGIN
			...
			IF((@currentusertype = 'sales representative'  OR @currentusertype = 'dispatcher') AND ISNULL(LEN(@empID),0) <> 0 AND @showAllOfficeLoads = 0)
			BEGIN
