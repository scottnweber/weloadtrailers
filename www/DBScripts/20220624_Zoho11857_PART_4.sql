UPDATE SystemConfig SET LoadsColumns = LoadsColumns + ',Bill From',LoadsColumnsStatus=LoadsColumnsStatus+',0' WHERE LoadsColumns NOT LIKE '%Bill From%'
GO

/****** Object:  StoredProcedure [dbo].[USP_GetLoadList]    Script Date: 24-06-2022 16:09:17 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[USP_GetLoadListBETA]    Script Date: 24-06-2022 16:16:07 ******/
SET ANSI_NULLS ON
GO
