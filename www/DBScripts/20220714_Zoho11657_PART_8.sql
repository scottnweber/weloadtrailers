IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Customers' and column_name = 'SalesRepID2')
BEGIN
	ALTER TABLE Customers ADD SalesRepID2 varchar(36);
END

IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Customers' and column_name = 'AcctMGRID2')
BEGIN
	ALTER TABLE Customers ADD AcctMGRID2 varchar(36);
END

GO

/****** Object:  StoredProcedure [dbo].[USP_GetCustomerDetails]    Script Date: 14-07-2022 17:22:50 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[USP_UpdateCustomer]    Script Date: 14-07-2022 17:25:46 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[USP_InsertCustomer]    Script Date: 14-07-2022 17:34:25 ******/
SET ANSI_NULLS ON
GO
