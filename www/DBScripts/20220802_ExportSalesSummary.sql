...
/****** Object:  View [dbo].[ExportSalesSummary]    Script Date: 02/08/2022 10:18:55 ******/
SET ANSI_NULLS ON
GO
...
SELECT        TOP (100) PERCENT dbo.Offices.Location, dbo.Offices.OfficeCode, dbo.Employees.Name AS Dispatcher, ISNULL(NULLIF (Employees_1.Name, N''), N'(BLANK)') AS SalesAgent1, dbo.Loads.LoadNumber, dbo.Loads.orderDate, 
						 ...
						 dbo.Loads.TotalCarrierCharges, dbo.Loads.BillDate AS InvoiceDate, dbo.Loads.InternalRef AS [Internal Ref#],
...
/****** Object:  View [dbo].[ExportSalesDetail]    Script Date: 02/08/2022 10:19:15 ******/
SET ANSI_NULLS ON
GO
...
SELECT  TOP 100 PERCENT dbo.ExportSalesSummary.Dispatcher, dbo.ExportSalesSummary.SalesAgent1, dbo.ExportSalesSummary.LoadNumber, dbo.ExportSalesSummary.orderDate, dbo.ExportSalesSummary.CustName, 
                         ...
                         dbo.LoadStopCommodities.CarrRateOfCustTotal,dbo.ExportSalesSummary.[Delivery Date],dbo.ExportSalesSummary.CompanyID,dbo.ExportSalesSummary.OfficeCode,dbo.ExportSalesSummary.[Internal Ref#]
