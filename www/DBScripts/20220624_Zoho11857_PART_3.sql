...
/****** Object:  StoredProcedure [dbo].[USP_GetCarrierDetails]    Script Date: 24-06-2022 15:49:06 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
 	 if @carrierID =  ''
 		SELECT  0 AS RatePrMile, NULL as carrierID, NULL as CarrierName, NULL as Address, NULL as City, NULL as stateCode,
				...
				,NULL as PhoneExt,NULL as FaxExt,NULL as TollFreeExt,NULL as CellPhoneExt,NULL AS ContactPerson,NULL AS RemitName
