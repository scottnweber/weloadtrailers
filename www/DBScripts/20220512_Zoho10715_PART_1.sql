IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Employees' and column_name = 'DefaultSalesRepToLoad')
BEGIN
	ALTER TABLE Employees ADD DefaultSalesRepToLoad bit not null default 0;
END

IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'Employees' and column_name = 'DefaultDispatcherToLoad')
BEGIN
	ALTER TABLE Employees ADD DefaultDispatcherToLoad bit not null default 0;
END


GO
/****** Object:  StoredProcedure [dbo].[USP_InsertAgent]    Script Date: 12/05/2022 11:13:49 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[USP_UpdateAgent]    Script Date: 12/05/2022 11:18:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
