...
/****** Object:  StoredProcedure [dbo].[USP_GetCustomerReport]    Script Date: 30-09-2022 10:53:26 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	SELECT
		...
		S.ForeignCurrencyEnabled,
		Curr.CurrencyNameISO,
		...
		From Loads L
			...
			LEFT JOIN Currencies Curr ON L.CustomerCurrency = Curr.CurrencyID
