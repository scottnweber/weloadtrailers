IF NOT EXISTS (SELECT column_name FROM INFORMATION_SCHEMA.columns where table_name = 'SystemConfig' and column_name = 'CustomerInvoiceformat')
BEGIN
	ALTER TABLE SystemConfig ADD CustomerInvoiceformat INT NOT NULL DEFAULT(0);
END


GO

/****** Object:  View [dbo].[vwCustomerInvoiceReportSub]    Script Date: 28-07-2022 10:53:32 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  View [dbo].[vwCustomerInvoiceReport]    Script Date: 28-07-2022 10:53:25 ******/
SET ANSI_NULLS ON
GO
...
SELECT        LoadID, LoadNumber, PayerName, PayerStreet, PayerCity, PayerState, PayerZip, PayerContact, PayerPhone, PayerFax, StopNo, ShipperName, ShipperAddress, ShipperCity, ShipperState, ShipperZip, ShipperContact, 
						 ...
						 ,InfoColor,ShipperEmail,DestEmail,PayerEmail,CustomerInvoiceformat
