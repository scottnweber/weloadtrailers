<cfoutput>
    <cfinvoke component="#variables.objLoadGateway#" method="getGLFinancialSetup" returnvariable="qGLFinancialSetup" />
    <style type="text/css">
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('change', '.GL-Fields', function () {
                ...
                $.ajax({
                    type    : 'POST',
                    url     : "../gateways/loadgateway.cfc?method=setGLFinancialSetup",
        ...
        function delRow(ID){
            if(ID != 0){
                if(confirm('Are you sure you want to delete this row?')){
                    $.ajax({
                        type    : 'POST',
                        url     : "../gateways/loadgateway.cfc?method=deleteGLFinancialSetup",
    ...
    <table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
        ...
        <tbody id="body-list">
            <cfloop query="qGLFinancialSetup">
                <tr id="tr_#qGLFinancialSetup.ID#">
                    <td height="20" class="sky-bg">&nbsp;</td>
                    <td class="sky-bg2" valign="middle" align="center" id="id_#qGLFinancialSetup.ID#">#qGLFinancialSetup.ID#</td>
                    <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">
                        <cfset listProfitType = "Gross Profit,Net Profit,Total Net Profit">
                        <select id="ProfitType_#qGLFinancialSetup.ID#" class="GL-Fields" style="width:100%;">
                            <cfloop list="#listProfitType#" index="Type">
                                <option value="#Type#" <cfif qGLFinancialSetup.ProfitType EQ Type>selected </cfif>>#Type#</option>
                            </cfloop>
                        </select>
                    </td>
                    <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">
                        <input  style="width:98%;" class="GL-Fields" id="MainTitle_#qGLFinancialSetup.ID#" value="#qGLFinancialSetup.MainTitle#">
                    </td>
                    <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">
                        <input style="width:92%;text-align: right;" class="GL-Fields" id="MainSort_#qGLFinancialSetup.ID#" value="#qGLFinancialSetup.MainSort#">
                    </td>
                    <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">
                        <input style="width:98%;" class="GL-Fields" id="SubTitle_#qGLFinancialSetup.ID#" value="#qGLFinancialSetup.SubTitle#">
                    </td>
                    <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">
                        <input  style="width:92%;text-align: right;" class="GL-Fields" id="SubSort_#qGLFinancialSetup.ID#" value="#qGLFinancialSetup.SubSort#">
                    </td>
                    <td align="left" valign="middle" nowrap="nowrap" class="normal-td">
                       <input style="width:95%;" class="GL-Fields" id="GLAcctFrom_#qGLFinancialSetup.ID#" value="#qGLFinancialSetup.GLAcctFrom#">
                    </td>
                    <td  align="right" valign="middle" nowrap="nowrap" class="normal-td">
                        <input style="width:95%;" class="GL-Fields" id="GLAcctTo_#qGLFinancialSetup.ID#" value="#qGLFinancialSetup.GLAcctTo#">
                    </td>
                    <td  align="left" valign="middle" nowrap="nowrap" class="normal-td2">
                        <img onclick="delRow(#qGLFinancialSetup.ID#)" src="images/delete-icon.gif" style="width:10px;margin-left: 5px;cursor: pointer;float:left" id="del_#qGLFinancialSetup.ID#">
                    </td>
