...
<cfoutput>
    ...
    <h1>CSV Import Log - <cfif  request.qGetSystemSetupOptions.freightBroker EQ 1>Carriers<cfelseif request.qGetSystemSetupOptions.freightBroker EQ 2>Carriers/Drivers<cfelse>Drivers</cfif></h1>
    <div style="clear:left"></div>
    <div class="search-panel">
        <div class="form-search">
            <cfset frmAction = "index.cfm?event=CarrierCsvImportLog&#session.URLToken#">
            <cfform id="dispCarrierLogsForm" name="dispCarrierLogsForm" action="#frmAction#" method="post" preserveData="yes">
    ...
    <cfif isdefined("form.searchText") >
	   <cfinvoke component="#variables.objCarrierGateway#" method="getCarrierCsvImportLog" searchText="#form.searchText#" pageNo="#form.pageNo#" sortorder="#form.sortOrder#" sortby="#form.sortBy#" returnvariable="qLogs" />
    <cfelse>
	   <cfinvoke component="#variables.objCarrierGateway#" method="getCarrierCsvImportLog" returnvariable="qLogs" />
    </cfif>
    ...
    <table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
        <thead>
            <tr>
                ...
                <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('MCNumber','dispCarrierLogsForm')">MC ##</th>
                <th width="120" align="center" valign="middle" class="head-bg">Message</th>
                <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('CreatedBy','dispCarrierLogsForm')">Created By</th>
                <th width="300" align="center" valign="middle" class="head-bg2" onclick="sortTableBy('CreatedDate','dispCarrierLogsForm')">Date/ Time</th>
        ...
        <tbody>
            <cfloop query="qLogs">
                <tr style="cursor: default;" <cfif qLogs.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>bgcolor="##f7f7f7"</cfif>>
                    ...
                    <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLogs.MCNumber#</td>
        ...
        <tfoot>
            <tr>
                ...
                <td colspan="5" align="left" valign="middle" class="footer-bg">
                    <div class="up-down">
                        <div class="arrow-top">
                            <a href="javascript: tablePrevPage('dispCarrierLogsForm');">
                                <img src="images/arrow-top.gif" alt="" />
                            </a>
                        </div>
                        <div class="arrow-bot">
                            <a href="javascript: tableNextPage('dispCarrierLogsForm');">
                    ...
                    <div class="gen-left" style="font-size: 14px;">
                        <cfif qLogs.recordcount>
                            <button type="button" class="bttn_nav" onclick="tablePrevPage('dispCarrierLogsForm');">PREV</button>
                          Page
                          <input type="text" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<cfif structKeyExists(form, "pageNo")>#form.pageNo#<cfelse>1</cfif>" id="jumpPageNo" style="text-align: center;width: 25px;" onchange="jumpToPage('dispCarrierLogsForm')">
                              <input type="hidden" id="TotalPages" value="#qLogs.TotalPages#">
                          of #qLogs.TotalPages#
                          <button type="button" class="bttn_nav" onclick="tableNextPage('dispCarrierLogsForm');">NEXT</button>
                        </cfif>
                    </div>
