...
<cfelse>
	<cfset newAgentUrl = "javascript: alert('Sorry!! You don\'t have rights to add new Users.');">
</cfif>
...
<table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<th width="120" align="center" valign="middle" class="head-bg" onclick="document.location.href='index.cfm?event=agent&sortorder=#sortorder#&sortby=Name&#session.URLToken#'">Name</th>
	...
	<th width="78" align="center" valign="middle" class="head-bg" onclick="document.location.href='index.cfm?event=agent&sortorder=#sortorder#&sortby=isActive&#session.URLToken#'">Status</th>
	<th width="78" align="center" valign="middle" class="head-bg2" onclick="document.location.href='index.cfm?event=agent&sortorder=#sortorder#&sortby=SalesCommission&#session.URLToken#'">Comm %</th>
  ...
  <tbody>
	...
	<tr <cfif request.qAgent.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>bgcolor="##f7f7f7"</cfif>>
		...
		<td class="normal-td" valign="middle" onclick="document.location.href='index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#'" align="left"><a href="index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#">#request.qAgent.name#</a></td>
		<td class="normal-td" valign="middle" onclick="document.location.href='index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#'" align="left"><a href="mailto:#request.qAgent.emailId#">#request.qAgent.emailId#</a></td>
		<td class="normal-td" valign="middle" onclick="document.location.href='index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#'" align="left"><a href="index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#">#request.qAgent.loginid#</a></td>
		<td class="normal-td" valign="middle" onclick="document.location.href='index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#'" align="left"><cfif request.qoffices.recordcount><a href="index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#">#request.qoffices.location#</a></cfif></td>
		<td class="normal-td" valign="middle" onclick="document.location.href='index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#'" align="left"><cfif request.qRoles.recordcount><a href="index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#">#request.qRoles.roleValue#</a></cfif></td>
		...
		<td class="normal-td2" valign="middle" onclick="document.location.href='index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#'" align="left"><a href="index.cfm?event=addagent&agentId=#request.qAgent.employeeID#&#session.URLToken#">#request.qAgent.SalesCommission#%</a></td>
