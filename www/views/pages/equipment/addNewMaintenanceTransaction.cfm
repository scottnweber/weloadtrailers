...
<cfoutput>
	...
	<div class="white-con-area" style="height: 36px;background-color: ##82bbef;">
		<div style="float: left; width: 20%;" id="divUploadedFiles">
					&nbsp;<a style="display:block;font-size: 13px;padding-left: 10px;color:white;margin-top:-5px;" href="##" onclick="popitupEquip('../fileupload/multipleFileupload/MultipleUpload.cfm?id=#tempEquipmentMaintTransId#&attachTo=59&user=#session.adminusername#&newFlag=1&dsn=#dsn#&attachtype=MaintTrans&CompanyID=#session.CompanyID#')">
	...
	<div class="white-con-area">
		...
		<div class="white-mid">
			<cfform name="frmPopUpMaintenance" action="index.cfm?event=addDriverEquipment&equipmentid=#url.equipmentid#&#session.URLToken#&IsCarrier=#url.IsCarrier#" method="post" enctype="multipart/form-data">
				<cfset TheKey = "NAMASKARAM">
				...
				<div class="form-con">
					<fieldset  style="margin-top: 25px;">
						...
						<div class="clear"></div>
						<label>Date</label>
							<input name="Date" type="datefield" style="width:75px;" id="Date" onblur="checkDateFormatAll(this);" value="" class="datefield">
						<div class="clear"></div>
