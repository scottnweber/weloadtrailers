...
<cfform name="frmClass" action="index.cfm?event=addclass:process&editid=#editid#&#session.URLToken#" method="post">
	...
	<fieldset>        
        ...
        <cfinput type="text" name="ClassName" value="#ClassName#" size="25" required="yes" message="The Class Name can only contain numbers, please fix this before continuing." validate="float" maxlength="50">
        <div class="clear"></div>
    </fieldset>
    </div>
    <div class="form-con">
