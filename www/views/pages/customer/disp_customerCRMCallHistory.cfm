...
<cfoutput>
    ...
    <div class="search-panel">
        <div class="form-search">
            <cfform id="dispCRMCallsForm" name="dispCRMCallsForm" action="index.cfm?event=customerCRMCallHistory&#session.URLToken#" method="post" preserveData="yes">
    ...
    <cfif isdefined("form.searchText") >
    	<cfinvoke component="#variables.objCustomerGateway#" method="getCRMCallHistory" searchText="#form.searchText#" pageNo="#form.pageNo#" sortorder="#form.sortOrder#" sortby="#form.sortBy#" returnvariable="qCRMCallHis" />
    <cfelse>
    	<cfinvoke component="#variables.objCustomerGateway#" method="getCRMCallHistory" returnvariable="qCRMCallHis"/>
    </cfif>
    <cfset pageSize = 30>
    ...
    <table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
        <thead>
            <tr>
              ...
              <th align="center" valign="middle" class="head-bg" onclick="sortTableBy('C.CustomerName','dispCRMCallsForm')">Company</th>
        ...
        <tbody>
          <cfloop query="qCRMCallHis">
            <cfset href="index.cfm?event=customerCRMCallDetail&CRMNoteID=#qCRMCallHis.CRMNoteID#&#session.URLToken#">
