...
<cfoutput>
    ...
    <h1>CSV Import Log - Customers</h1>
    <div style="clear:left"></div>
    <div class="search-panel">
        <div class="form-search">
            <cfset frmAction = "index.cfm?event=CustomerCsvImportLog&#session.URLToken#">
            <cfform id="dispCustomerLogsForm" name="dispCustomerLogsForm" action="#frmAction#" method="post" preserveData="yes">
    ...
    <cfif isdefined("form.searchText") >
	   <cfinvoke component="#variables.objCustomerGateway#" method="getCustomerCsvImportLog" searchText="#form.searchText#" pageNo="#form.pageNo#" sortorder="#form.sortOrder#" sortby="#form.sortBy#" returnvariable="qLogs" />
    <cfelse>
	   <cfinvoke component="#variables.objCustomerGateway#" method="getCustomerCsvImportLog" returnvariable="qLogs" />
    </cfif>
    ...
    <table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
        <thead>
            <tr>
                ...
                <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('CustomerCode','dispCustomerLogsForm')">Customer Code</th>
                <th width="120" align="center" valign="middle" class="head-bg">Message</th>
                <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('CreatedBy','dispCustomerLogsForm')">Created By</th>
                <th width="300" align="center" valign="middle" class="head-bg2" onclick="sortTableBy('CreatedDate','dispCustomerLogsForm')">Date/ Time</th>
        ...
        <tbody>
            <cfloop query="qLogs">
                <tr style="cursor: default;" <cfif qLogs.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>bgcolor="##f7f7f7"</cfif>>
                    ...
                    <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLogs.CustomerCode#</td>
        ...
        <tfoot>
            <tr>
                ...
                <td colspan="5" align="left" valign="middle" class="footer-bg">
                    <div class="up-down">
                        <div class="arrow-top">
                            <a href="javascript: tablePrevPage('dispCustomerLogsForm');">
                                <img src="images/arrow-top.gif" alt="" />
                            </a>
                        </div>
                        <div class="arrow-bot">
                            <a href="javascript: tableNextPage('dispCustomerLogsForm');">
                    ...
                    <div class="gen-left" style="font-size: 14px;">
                        <cfif qLogs.recordcount>
                            <button type="button" class="bttn_nav" onclick="tablePrevPage('dispCustomerLogsForm');">PREV</button>
                          Page
                          <input type="text" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<cfif structKeyExists(form, "pageNo")>#form.pageNo#<cfelse>1</cfif>" id="jumpPageNo" style="text-align: center;width: 25px;" onchange="jumpToPage('dispCustomerLogsForm')">
                              <input type="hidden" id="TotalPages" value="#qLogs.TotalPages#">
                          of #qLogs.TotalPages#
                          <button type="button" class="bttn_nav" onclick="tableNextPage('dispCustomerLogsForm');">NEXT</button>
                        </cfif>
                    </div>
