...
<cfset frmAction = "index.cfm?event=customerCRMReminder&#session.URLToken#">
...
<cfif isdefined("form.searchText") >
	<cfinvoke component="#variables.objCustomerGateway#" method="getCRMCallsReminder" searchText="#form.searchText#" pageNo="#form.pageNo#" sortorder="#form.sortOrder#" sortby="#form.sortBy#" returnvariable="qCRMCalls" />
<cfelse>
	<cfinvoke component="#variables.objCustomerGateway#" method="getCRMCallsReminder" returnvariable="qCRMCalls" />
</cfif>
...
<table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
      ...
      <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('C.CustomerName','dispCRMCallsForm')">Name</th>

      <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('C.Location','dispCRMCallsForm')">Address</th>
      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('C.City','dispCRMCallsForm')">City</th>
       ...
       <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('C.Zipcode','dispCRMCallsForm')">Zip</th>
       <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('C.PhoneNo','dispCRMCallsForm')">Phone No.</th>
       <th width="120" align="center" valign="middle" class="head-bg">Office</th>
       <th width="40" align="center" valign="middle" class="head-bg"  onclick="sortTableBy('C.CRMNextCallDate','dispCRMCallsForm');">Next Call</th>
      ...
      <th width="120" align="center" valign="middle" class="head-bg2" onclick="sortTableBy('C.CustomerStatusID','dispCRMCallsForm')">Status</th>
