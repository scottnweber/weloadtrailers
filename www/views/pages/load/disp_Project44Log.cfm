...
<cfset frmAction = "index.cfm?event=Project44Log&#session.URLToken#">
...
<cfif isdefined("form.searchText") >
	<cfinvoke component="#variables.objLoadGateway#" method="getProject44Log" searchText="#form.searchText#" pageNo="#form.pageNo#" sortorder="#form.sortOrder#" sortby="#form.sortBy#" returnvariable="qLoadLogs" />
<cfelse>
	<cfinvoke component="#variables.objLoadGateway#" method="getProject44Log" returnvariable="qLoadLogs" />
</cfif>
...
<table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
      ...
      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('BOLNum','dispLoadLogsForm')">BOL Number</th>

      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('Message','dispLoadLogsForm')">Message</th>
