...
<cfoutput>
	...
	<div class="importLoads">
			<table width="100%">
				<tr>
					<th class="importLoadsheader">
						<div class="fa fa-minus-circle PlusToggleButton" style="margin-top: 0;margin-left: 0;" onclick="showHideInterModalImport(this,'#url.stopno#');"></div>
						IMPORT LOADS
					</th>
				</tr>
			</table>
			<div class="InterModalImport#url.stopno#">
			<table>
	...
	<div class="exportLoads">
		<table width="100%">
			<tr>
				<th class="exportLoadsheader">
					<div class="fa fa-minus-circle PlusToggleButton" style="margin-top: 0;margin-left: 0;" onclick="showHideInterModalExport(this,'#url.stopno#');"></div>
					EXPORT LOADS
				</th>
			</tr>
		</table>
		<div class="InterModalExport#url.stopno#">
		<table>
			<tr style="height: 40px;">
				<td>
					TYPE TO SELECT
