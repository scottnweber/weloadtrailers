...
<cfset frmAction = "index.cfm?event=EmailLog&#session.URLToken#">
...
<cfform id="dispLoadLogsForm" name="dispLoadLogsForm" action="#frmAction#" method="post" preserveData="yes">
  <cfinput id="pageNo" name="pageNo" value="1" type="hidden">
    ...
    <cfinput id="sortBy" name="sortBy" value="CreateDate" type="hidden">
...
<cfif isdefined("form.searchText") >
	<cfinvoke component="#variables.objLoadGateway#" method="getEmailLog" searchText="#form.searchText#" pageNo="#form.pageNo#" sortorder="#form.sortOrder#" sortby="#form.sortBy#" returnvariable="qLoadLogs" />
<cfelse>
	<cfinvoke component="#variables.objLoadGateway#" method="getEmailLog" returnvariable="qLoadLogs" />
</cfif>
...
<table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
      ...
      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('LoadNo','dispLoadLogsForm')">Load ##</th>

      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('Subject','dispLoadLogsForm')">Subject</th>

      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('emailBody','dispLoadLogsForm')">Body</th>
       <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('fromAddress','dispLoadLogsForm')">From</th>
       <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('toAddress','dispLoadLogsForm')">To</th>
      <th width="300" align="center" valign="middle" class="head-bg2" onclick="sortTableBy('CreateDate','dispLoadLogsForm')">Date/ Time</th>
      ...
      <tbody>
        ...
        <tr style="cursor: default;" <cfif qLoadLogs.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>bgcolor="##f7f7f7"</cfif>>
          ...
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.LoadNo#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.Subject#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td EmailBody">#qLoadLogs.emailBody#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.fromAddress#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.toAddress#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td2">#datetimeformat(qLoadLogs.CreateDate,'mm/dd/yyyy hh:nn tt')# </td>
