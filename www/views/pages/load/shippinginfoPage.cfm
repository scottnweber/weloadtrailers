<div class="form-heading">
		...
		<div class="form-con">
			...
			<fieldset>
				...
				<select name="Shipper" onchange="getShipperForm(this.value,'#application.DSN#');">
					<option>CHOOSE A PICKUP OR ENTER ONE BELOW</option>
		...
		<div class="form-con">
			<fieldset>
				...
				<div class="clear"></div>
				<label>&nbsp;</label>
				<label class="ch-box"><input name="shipBlind" id="shipBlind" type="checkbox" <cfif shipBlind is true> checked="checked" </cfif> class="check" />Pickup Blind</label>
				<div class="clear"></div>
