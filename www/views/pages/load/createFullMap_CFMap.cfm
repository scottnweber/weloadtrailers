 ...
 <div id="panel" style="width:500px; float: right;">
	...
	<cfif isdefined("URL.frstConAdd") and Len(#trim(URL.frstConAdd)#) gt 3>
		<cfmapitem 
				...
				markerwindowcontent="Stop No. 1 <br/>Delivery Name : #URL.frstConNm#<br/>Delivery Address : #URL.frstConAdd#" 
				name="mapitemname" 
				markercolor="009900" 
				tip="stop1"
				>
	...
	<cfif isdefined("URL.secShpAdd") and Len(#trim(URL.secShpAdd)#) gt 3 and #URL.secShpAdd# neq #URL.frstShpAdd# >
		<cfmapitem 
			...
			markerwindowcontent="Stop No. 2<br> Pickup Name : #URL.secShpAdd#" 
			name="mapitemname1" 
			markercolor="009900" 
			tip="stop2" 
			/>
	...
	<cfif isdefined("URL.secConAdd") and Len(#trim(URL.secConAdd)#) gt 3>
		<cfmapitem 
			...
			markerwindowcontent="Stop No. 2<br> Delivery Name : #URL.secConAdd#" 
			name="mapitemname1" 
			markercolor="009900" 
			tip="stop2" 
			/>
	...
	<cfif isdefined("URL.thirdShpAdd") and Len(#trim(URL.thirdShpAdd)#) gt 3 and #URL.thirdShpAdd# neq #URL.secShpAdd# >
		<cfmapitem 
			...
			markerwindowcontent="Stop No. 3<br> Pickup Name : #URL.thirdShpAdd#" 
			name="mapitemname1" 
			markercolor="009900" 
			tip="stop2" 
			/>
	...
	<cfif isdefined("URL.thirdConAdd") and Len(#trim(URL.thirdConAdd)#) gt 3>
		<cfmapitem 
			...
			markerwindowcontent="Stop No. 3<br> Delivery Name : #URL.thirdConAdd#" 
			name="mapitemname1" 
			markercolor="009900" 
			tip="stop2" />
	</cfif>
	...
	<cfif isdefined("URL.fourthShpAdd") and Len(#trim(URL.fourthShpAdd)#) gt 3 and #URL.fourthShpAdd# neq #URL.thirdShpAdd# >
		<cfmapitem 
			...
			markerwindowcontent="Stop No. 4<br> Pickup Name : #URL.fourthShpAdd#" 
			name="mapitemname1" 
			markercolor="009900" 
			tip="stop2" />
	</cfif>
	<cfif isdefined("URL.fourthConAdd") and Len(#trim(URL.fourthConAdd)#) gt 3>
		<cfmapitem 
			...
			markerwindowcontent="Stop No. 4<br> Delivery Name : #URL.fourthConAdd#" 
			name="mapitemname1" 
			markercolor="009900" 
			tip="stop2" />
	</cfif>
	...
	<cfif isdefined("URL.fifthShpAdd") and Len(#trim(URL.fifthShpAdd)#) gt 3 and #URL.fifthShpAdd# neq #URL.fourthShpAdd# >
		<cfmapitem 
			...
			markerwindowcontent="Stop No. 5<br> Pickup Name : #URL.fifthShpAdd#" 
			name="mapitemname1" 
			markercolor="009900" 
			tip="stop2" />
	</cfif>
	<cfif isdefined("URL.fifthConAdd") and Len(#trim(URL.fifthConAdd)#) gt 3>
		<cfmapitem 
			...
			markerwindowcontent="Stop No. 5<br> Delivery Name : #URL.fifthConAdd#" 
			name="mapitemname1" 
			markercolor="009900" 
			tip="stop2" />
	</cfif>
