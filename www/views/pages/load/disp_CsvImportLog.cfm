...
<cfset frmAction = "index.cfm?event=CsvImportLog&#session.URLToken#">
...
<cfif isdefined("form.searchText") >
	<cfinvoke component="#variables.objLoadGateway#" method="getCsvImportLog" searchText="#form.searchText#" pageNo="#form.pageNo#" sortorder="#form.sortOrder#" sortby="#form.sortBy#" returnvariable="qLoadLogs" />
<cfelse>
	<cfinvoke component="#variables.objLoadGateway#" method="getCsvImportLog" returnvariable="qLoadLogs" />
</cfif>
...
<table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
      ...
      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('L.LoadNumber','dispLoadLogsForm')">Load ##</th>

      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('L.BOLNum','dispLoadLogsForm')">BOL Number</th>

      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('CONVERT(varchar(max), p.message)','dispLoadLogsForm')">Message</th>
       <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('C.CustomerName','dispLoadLogsForm')">Customer</th>

      <th width="300" align="center" valign="middle" class="head-bg2" onclick="sortTableBy('P.CreatedDate','dispLoadLogsForm')">Date/ Time</th>
      ...
      <tbody>
        ...
        <tr style="cursor: default;" <cfif qLoadLogs.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>bgcolor="##f7f7f7"</cfif>>
          ...
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.BOLNum#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.message#</td>
