...
<cfset frmAction = "index.cfm?event=TextLog&#session.URLToken#">
...
<cfif isdefined("form.searchText") >
	<cfinvoke component="#variables.objLoadGateway#" method="getTextLog" searchText="#form.searchText#" pageNo="#form.pageNo#" sortorder="#form.sortOrder#" sortby="#form.sortBy#" returnvariable="qLoadLogs" />
<cfelse>
	<cfinvoke component="#variables.objLoadGateway#" method="getTextLog" returnvariable="qLoadLogs" />
</cfif>
...
<table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
      ...
      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('textBody','dispLoadLogsForm')">Body</th>
       <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('fromNumber','dispLoadLogsForm')">From</th>
       <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('toNumber','dispLoadLogsForm')">To</th>
      ...
      <tbody>
        ...
        <tr style="cursor: default;" <cfif qLoadLogs.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>bgcolor="##f7f7f7"</cfif>>
          ...
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td TextBody">#qLoadLogs.textBody#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.fromNumber#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.toNumber#</td>
