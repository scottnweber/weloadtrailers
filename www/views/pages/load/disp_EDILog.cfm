...
<cfset frmAction = "index.cfm?event=EDILog&#session.URLToken#">
...
<cfif isdefined("form.searchText") >
	<cfinvoke component="#variables.objLoadGatewaynew#" method="getEDILog" searchText="#form.searchText#" pageNo="#form.pageNo#" sortorder="#form.sortOrder#" sortby="#form.sortBy#" returnvariable="qLoadLogs" />
<cfelse>
	<cfinvoke component="#variables.objLoadGatewaynew#" method="getEDILog" returnvariable="qLoadLogs" />
</cfif>
...
<table width="100%" border="0" class="data-table" cellspacing="0" cellpadding="0" style="color:##000000;">
      ...
      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('LOADID','dispLoadLogsForm')">Load ##</th>

      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('BOLNumber','dispLoadLogsForm')">BOL Number</th>

      <th width="120" align="center" valign="middle" class="head-bg" onclick="sortTableBy('DOCTYPE','dispLoadLogsForm')">Doc Type</th>

      <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('Detail','dispLoadLogsForm')">Action</th>
       <th width="300" align="center" valign="middle" class="head-bg" onclick="sortTableBy('CustomerName','dispLoadLogsForm')">Customer</th>
      ...
      <tbody>
        ...
        <tr style="cursor: default;" <cfif qLoadLogs.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>bgcolor="##f7f7f7"</cfif>>
          ...
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.BOLNumber#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.DOCTYPE#</td>
          <td  align="left" valign="middle" nowrap="nowrap" class="normal-td">#qLoadLogs.Detail#</td>
