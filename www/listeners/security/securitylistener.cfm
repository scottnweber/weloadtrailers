...
<cffunction name="doLogin" access="public" output="false" returntype="struct">
	...
	<cfscript>
		...
		var rstCurrentSiteUser = variables.objSecurityGateway.checkLogin(strUsername=arguments.strUsername, strPassword=arguments.strPassword, strCompanycode=arguments.strCompanycode);
		var structReturn = StructNew();
		var siteUserBean = GetBean("beans.siteuserbean");

		var trackUserLoginLog = variables.objSecurityGateway.UserLoginLog(strUsername=arguments.strUsername, strPassword=arguments.strPassword, rstCurrentSiteUser = rstCurrentSiteUser, strCompanycode=arguments.strCompanycode);
...
<cffunction name="CustomerdoLogin" access="public" output="false" returntype="struct">
	...
	<cfscript>
		...
		var rstCurrentSiteUser = variables.objSecurityGateway.checkCustomerLogin(strUsername=arguments.strUsername, strPassword=arguments.strPassword, strCompanycode=arguments.strCompanycode);
		var structReturn = StructNew();
		var siteUserBean = GetBean("beans.siteuserbean");
		var trackUserLoginLog = variables.objSecurityGateway.UserLoginLog(strUsername=arguments.strUsername, strPassword=arguments.strPassword, rstCurrentSiteUser = rstCurrentSiteUser, strCompanycode=arguments.strCompanycode);
		structReturn.IsLoggedIn = False; // Default Guilty until proven innocent
