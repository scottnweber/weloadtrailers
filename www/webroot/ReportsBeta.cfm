...
<cfoutput>
	...
	<div class="white-con-area">
	    <div class="white-mid">
	    	<form name="frmSalesReport" action="index.cfm?event=SalesReport&#session.URLToken#" method="post" onsubmit="return validateForm()">
	    		...
	    		<div class="form-con" style="margin-bottom: 20px;">
	    			<fieldset>
						...
						<div style="float: left;">
							<div style="float:left;">
				                <input type="checkbox" name="showOfficeSubtotal" value="" id="showOfficeSubtotal" style="width: 16px;"/>
				                 <label class="normal" for="showOfficeSubtotal" style="width:120px;text-align:left;">Show Office Subtotals</label>
				            </div> 
				            <div class="clear"></div> 
		    				...
		    				<div class="clear"></div> 
		    				<div style="float:left;">
				                <input type="checkbox" name="showCommision" value="" id="showCommision" checked style="width: 16px;"/>
				                 <label class="normal" for="showCommision" style="width:120px;text-align:left;">Show Commissions</label>
				            </div> 
				            <div class="clear"></div> 
						...
						<div style="border-top: 1px solid ##77463d; margin-top: 56px;">	
			            	<div style="float:right;margin-right: -51px;">	
								...
								<div style="float:left;">
									<input type="checkbox" name="ShowReportCriteria" value="" id="ShowReportCriteria"  style="margin-left: -83px;margin-top: 13px;">
								</div>
							...
							<div style="float:right;margin-right: -51px;">	
								...
								<div style="float:left;">
									<input type="checkbox" name="ShowSummaryOnly" value="" id="ShowSummaryOnly"  style="margin-left: -83px;margin-top: 13px;">
								</div>
								<div style="clear:both;"></div> 	
					        </div>  	
				           	<div class="clear"></div> 	
				           	<div style="float:right; margin-right:-51px;">	
								...
								<div style="float:left;">
									<input type="checkbox" name="ShowProfit" checked value="" id="ShowProfit"  style="margin-left: -83px;margin-top: 13px;">
								</div>
								<div style="clear:both;"></div> 	
					        </div>  	
				           	<div class="clear"></div>
