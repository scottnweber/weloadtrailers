...
function checkLoadNext(stopid)
{
	...
	{
	    alert('Please enter a valid Pickup for stop '+stopidForMessage);
	    document.getElementById('shipper'+stopid).focus();
		enableDisableMainCalcFields(true);
		return false;
	}
	...
	if(document.getElementById('shipperstate'+stopid).value =="")
	{
	    ...
	    alert('Please select Pickup state for stop '+stopidForMessage);
		enableDisableMainCalcFields(true);
		return false;
	}
	...
	if(consigneeName==""  &&(consigneeIDContainer=="" || consigneeTitle==""))
	{
	    ...
	    alert('Please enter a valid Delivery for stop '+stopidForMessage);
		enableDisableMainCalcFields(true);
		return false;	
	}
	...
	if(document.getElementById('consigneestate'+stopid).value =="")
	{
	    ...
	    alert('Please select  Delivery state for stop '+stopidForMessage);
		enableDisableMainCalcFields(true);
		return false;	
	}
	...
	if(consigneeDeliveryDate=="")
	{
	    ...
	    alert('Please enter Delivery pickup date for stop '+stopidForMessage);
		enableDisableMainCalcFields(true);
		return false;	
	}
	return true;
