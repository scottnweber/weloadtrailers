...
<cfoutput>
	...
	<div class="white-con-area" style="height: 36px;background-color: ##82bbef;">
		<div style="float: left;"><h2 style="color:white;font-weight:bold;margin-left: 12px;">Print Trial Balance</h2></div>
	</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('##sReport').click(function(){	
			 	//if(checkdate()){
					var url = "../reports/LMAPrintTrialBalance.cfm?dsn=#dsn#";
