	...
	<div class="white-con-area">
	    ...
	    <div class="white-mid">
			<cfform name="frmCommissionReport" action="##" method="post">
				<div class="form-con">
					<fieldset>
						<h2 class="reportsSubHeading">Group By&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Type</h2>
						<div class="clear"></div>
	            		<div style="width:10px; float:left;">&nbsp;</div>
	            		<div style="float: left;">
		           			<div style="float:left;">
				                <cfinput type="radio" name="groupBy" value="none" id="none" checked="yes" style="width:15px; padding:0px 0px 0 0px;margin-bottom:1px;"  onclick="hideCustomerCheckBox();hidecheckBoxGroup();ckreportType(1);"/>
				                <label class="normal" for="salesAgent" style="text-align:left; padding:0 0 0 0;width: 90px;">None</label>
				                <input type="radio" name="reportType" value="1" id="reportType_1" style="width:15px; padding:0px 0px 0 0px;margin-bottom:1px;" checked/>
					            <label class="normal" for="reportType_1" style="text-align:left; padding:0 0 0 0;width: 90px;">Customer</label>
				            </div>
		    				<div class="clear"></div>
		        			<div style="float:left;">
				            	<cfif request.qGetSystemSetupOptions.freightBroker>	
				                	
				                	<cfinput type="radio" name="groupBy" value="salesAgent" id="salesAgent" style="width:15px; padding:0px 0px 0 0px;margin-bottom:1px;" onclick="hideCustomerCheckBox();showcheckBoxGroup();ckreportType(1);"/>
				                <cfelse>
				                	<cfif len(trim(request.qGetSystemSetupOptions.userDef7))>
				                			
				                		<cfinput type="radio" name="groupBy" value="#request.qGetSystemSetupOptions.userDef7#" id="salesAgent" style="width:15px; padding:0px 0px 0 0px;margin-bottom:1px;" onclick="hideCustomerCheckBox();showcheckBoxGroup();ckreportType(1);"/>	
				                	<cfelse>
				                		<cfinput type="radio" name="groupBy" value="salesAgent" id="salesAgent" style="width:15px; padding:0px 0px 0 0px;margin-bottom:1px;" onclick="hideCustomerCheckBox();showcheckBoxGroup();ckreportType(1);"/>
				                	</cfif>
				                </cfif>
		                		...
		                		<input type="radio" name="reportType" value="2" id="reportType_2" style="width:15px; padding:0px 0px 0 0px;margin-bottom:1px;"/>
					                <label class="normal" for="reportType_2" style="text-align:left; padding:0 0 0 0;width: 90px;">#variables.freightBroker#</label>
		            		</div>

		            		<div class="clear"></div>
		            		<div style="float:left;">
		                		<cfinput type="radio" name="groupBy" value="dispatcher" id="dispatcher"  style="width:15px; padding:0px 0px 0 0px;margin-bottom:1px;" onclick="hideCustomerCheckBox();showcheckBoxGroup();ckreportType(1);"/>
		                		<label class="normal" for="dispatcher" style="text-align:left; padding:0 0 0 0;width: 90px;" >Dispatcher</label>
		            		</div>			
							<div class="clear"></div>
		            		<div style="float:left;">
				                <cfinput type="radio" name="groupBy" value="customer" id="customer"  style="width:15px; padding:0px 0px 0 0px;margin-bottom:1px;" onclick="hideCustomerCheckBox();showcheckBoxGroup();ckreportType(1);"/>
				                <label class="normal" for="customer" style="text-align:left; padding:0 0 0 0;width: 90px;" >Customer</label>
				            </div>			
					 		<div class="clear"></div>
				            <div style="float:left;">
				                <cfinput type="radio" name="groupBy" value="#variables.freightBroker#" id="#variables.freightBroker#" style="width:15px; padding:0px 0px 0 0px;margin-bottom:1px;" onclick="showCustomerCheckBox();showcheckBoxGroup();ckreportType(2);"/>
				                <label class="normal" for="#variables.freightBroker#" style="text-align:left; padding:0 0 0 0;width: 90px;">#variables.freightBroker#</label>
				            </div>         
			            </div>   
			            <div style="float: left;">    
			            ...
			            <div style="margin-top:30px;">
				            ...
				            <label class="normal"><h2 style="float:left;padding: 0;">Pickup Date</h2></label>
						...
						<div class="clear"></div>
						<div style="margin-top: 30px;">
							<h2 style="margin-top:14px;" class="reportsSubHeading">
					 			<cfif request.qGetSystemSetupOptions.freightBroker>	
					            	Sales Rep
					            <cfelse>
					            	<cfif len(trim(request.qGetSystemSetupOptions.userDef7))>
	        			...
	        			<div class="clear"></div>
	            		<div>
	        				<h2 style="margin-top:14px;" class="reportsSubHeading">Dispatcher</h2>
		        			<label>From </label>
				...
				<div class="form-con">
					<fieldset>	
						...
						<cfinput type="hidden" name="appDsn" id="appDsn" value="#application.dsn#">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('##salesReportImg').click(function(){
				...
				getCommissionAgingReport('#session.URLToken#', 'mail',dsn,customerStatus,pageBreakStatus,ShowSummaryStatus,0);
			 });
			 $('##sReport').click(function(){	
				var dsn='#dsn#';
			 	...
			 	if(checkdate()){
				getCommissionAgingReport('#session.URLToken#', 'view',dsn,customerStatus,pageBreakStatus,ShowSummaryStatus,0);
			      }
			});
