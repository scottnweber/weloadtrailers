	    ...
	    <HTML xmlns="http://www.w3.org/1999/xhtml">
	        ...
	        <BODY style="font-family: 'Arial';">
	        	<cfdocumentitem type="header">
	        		...
	        		<table  width="100%" style="font-family: 'Arial';border-bottom: solid 3px gray;font-size: 14px;" cellspacing="0" cellpadding="0">
	        			<thead>
	        				<th width="10%">Check##</th>
	        				<th width="10%">Chk Date</th>
	        				<th width="15%">Vendor Code</th>
	        				<th width="35%">Description</th>
	        				<th width="15%"  align="right">Voided Amt</th>
	        				<th width="25%"  align="right">Check Amt</th>
	        			</thead>
	        		</table>
	            </cfdocumentitem>
	            <cfif structKeyExists(url, "groupBybank") and url.groupBybank eq 1>
	            	<table width="100%" style="font-family: 'Arial';font-size: 14px;margin-top: -10px;" cellspacing="0" cellpadding="0">
	            		...
	            		<cfloop query="qInvoicePayment" group="checkaccount">
        					...
        					<tr>
        						...
        						<td colspan="5" style="border-bottom: solid 1px;"><b>Account: </b>#qInvoicePayment.bank#</td>
        					</tr>
	        				<cfloop group="checknumber">
		            			...
		            			<tr>
		            				<td  width="10%"  align="center">#qInvoicePayment.checknumber#</td>
		            				<td  width="10%"  align="center">#dateformat(qInvoicePayment.checkdate,"m/d/yyyy")#</td>
		            				<td  width="15%"  align="center">#qInvoicePayment.vendorcode#</td>
		            				<td  width="35%" align="center">#qInvoicePayment.description#</td>
		            				<td width="15%" align="right">$0.00</td>
		            				<td width="25%" align="right">#DollarFormat(TotalForVendor)#</td>
		            			</tr>
		            		</cfloop>
		            		<tr>
	    						<td style="border-top: solid 1px;"><b>Bank ##: </b>#qInvoicePayment.checkaccount#</td>
	    						<td style="border-top: solid 1px;" colspan="2"><b>Account: </b>#qInvoicePayment.bank#</td>
	    						<td style="border-top: solid 1px;"  align="right"><b>Net Total: </b></td>
	    						<td style="border-top: solid 1px;"  align="right"><b>#DollarFormat(voidTotal)# </b></td>
	    						<td style="border-top: solid 1px;"  align="right"><b>#DollarFormat(bankTotal)# </b></td>
	    					</tr>
		            	</cfloop>
		            	<!--- <tr>
    						...
    						<td style="border-bottom: solid 1px;"  align="right"><b>Net Total: </b></td>
    						<td style="border-bottom: solid 1px;"  align="right"><b>#DollarFormat(voidTotal)# </b></td>
    						<td style="border-bottom: solid 1px;"  align="right"><b>#DollarFormat(bankTotal)# </b></td>
    					</tr> --->
	            		<tr>
	    					<td colspan="5" align="right" style="border-top:solid 1px;"><b>TOTAL:</b></td>
	    					<td colspan="1" align="right" style="border-top:solid 1px;"><b>#DollarFormat(grandTotal)#</b></td>
	    				</tr>
	            	</table>
	            <cfelse>
	            	<table width="100%" style="font-family: 'Arial';font-size: 14px;margin-top: -10px;" cellspacing="0" cellpadding="0">
